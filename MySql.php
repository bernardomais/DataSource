...
/**
 * MySql PDO PHP Persistence Class
 * https://github.com/bernardomais/DataSources
 *
 *
 * @author Bernardo Albuquerque - bernardomais@gmail.com
 */
...
class MySql {
    ...
    public function __construct() {
        $this->debug = true;
        $this->server = "127.0.0.1";    # localhost || ip address
